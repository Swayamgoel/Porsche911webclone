...
const urlsPdsBlacklist = ['//www.overtake.gg','//overtake.gg','//customer.drive.porsche.com','//www.porscheclubnews.com','//porscheclubnews.com','//dealer.porsche.com','//cd.staging.dwaas.weu.porsche.com','//dealerwebtest.westeurope.cloudapp.azure.com'];
...
if(urlParams.get('uc-refactor') === 'true' || window.location.hash.includes('#uc-refactor=true')) {
	onPdsBlacklist = false;
	srcPds = 'https://www.porsche.com/all/usercentrics/udg-uc-sdk-pds-2.1.1.min.js';
}
